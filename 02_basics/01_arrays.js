 ...
 *** 1. collection of multiple items in single  variable mai rakh sakatea hai 
     ...
     5. arrrayindexing start with 0 and we can access elemnts through indexing
...
myArr.unshift(9) // insert the array to add the elements in the start 
...
console.log(typeof(newArr)) // convert the  array elements in the string
